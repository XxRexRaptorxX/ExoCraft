...
public class ModConfiguredFeatures {
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> LAVA_CRYSTAL_GEN = Suppliers.memoize(() -> List.of(
            OreConfiguration.target(OreFeatures.NETHER_ORE_REPLACEABLES, ModBlocks.LAVA_CRYSTAL_ORE.get().defaultBlockState())));

    public static final RegistryObject<ConfiguredFeature<?, ?>> LAVA_CRYSTAL = CONFIGURED_FEATURES.register("lava_crystal",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(LAVA_CRYSTAL_GEN.get(),3)));
